...
reportgenerator "-title:PublicTransportationScheduler Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:PublicTransportationScheduler Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/publictransportationscheduler_tests
./publish_linux/bin/publictransportationschedulerapp
...
reportgenerator "-title:PublicTransportationScheduler Library Unit Test Coverage Report (Linux)" "-reports:**/coverage_linux.info" "-targetdir:docs/coveragereportliblinux" "-reporttypes:Html" 

"-sourcedirs:src/utility/src;src/utility/header;src/publictransportationscheduler/src;src/publictransportationscheduler/header;src/publictransportationschedulerapp/src;src/publictransportationschedulerapp/header;src/tests/utility;src/tests/publictransportationscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_linux"
reportgenerator "-reports:**/coverage_linux.info" "-targetdir:assets/codecoverageliblinux" "-reporttypes:Badges" "-sourcedirs:src/utility/src;src/utility/header;src/publictransportationscheduler/src;src/publictransportationscheduler/header;src/publictransportationschedulerapp/src;src/publictransportationschedulerapp/header;src/tests/utility;src/tests/publictransportationscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
cp -R src/publictransportationscheduler/header build_linux/build/Release
...
cp -R src/publictransportationscheduler/header build_linux/build/Debug

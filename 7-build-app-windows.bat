...
call reportgenerator "-title:PublicTransportationScheduler Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:PublicTransportationScheduler Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for PublicTransportationScheduler
call OpenCppCoverage.exe --export_type=binary:publictransportationscheduler_tests_unit_win.cov --sources src\publictransportationscheduler\src --sources src\publictransportationscheduler\header --sources src\tests\publictransportationscheduler -- build_win\build\Debug\publictransportationscheduler_tests.exe

echo Generate Test Coverage Data for PublicTransportationScheduler App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=publictransportationscheduler_tests_unit_win.cov --export_type=cobertura:publictransportationschedulerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\publictransportationscheduler\src --sources src\publictransportationscheduler\header --sources src\publictransportationschedulerapp\src --sources src\publictransportationschedulerapp\header --sources src\tests\utility --sources src\tests\publictransportationscheduler -- build_win\build\Debug\publictransportationschedulerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:PublicTransportationScheduler Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/publictransportationschedulerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/publictransportationscheduler/src;src/publictransportationscheduler/header;src/publictransportationschedulerapp/src;src/publictransportationschedulerapp/header;src/tests/utility;src/tests/publictransportationscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/publictransportationschedulerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/publictransportationscheduler/src;src/publictransportationscheduler/header;src/publictransportationschedulerapp/src;src/publictransportationschedulerapp/header;src/tests/utility;src/tests/publictransportationscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\publictransportationscheduler\header "build_win\build\Release" /E
call robocopy src\publictransportationschedulerapp\header "build_win\build\Release" /E
...
call robocopy src\publictransportationscheduler\header "build_win\build\Debug" /E
call robocopy src\publictransportationschedulerapp\header "build_win\build\Debug" /E
